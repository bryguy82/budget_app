...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 19, 2020 at 09:28 PM
...
CREATE TABLE `debt` (
  ...
  `curPayment` int(11) NOT NULL,
  `calcInterest` int(11) NOT NULL,
  `calcPrincipal` int(11) NOT NULL,
  `curBalance` int(11) NOT NULL,
  `totInterest` int(11) NOT NULL,
...
INSERT INTO `debttrackers` (`debtTrackerId`, `name`, `category`, `interest`, `term`, `loanValue`, `userId`) VALUES
(1, 'name', 'Home Mortgage', 3, 10, 1000, 4),
(2, 'tracker', 'Home Mortgage', 4, 10, 101010, 4),
(3, 'Car', 'debt', 4, 60, 36000, 4),
(4, 'Laptop', 'debt', 0, 1, 12, 3000);
...
(11, '2020-03-13', 100, 10, 0, 110, 23),
(12, '2020-03-15', 1000, 100, 4, 1104, 2),
(14, '2020-03-15', 100, 10, 0, 110, 2);
...
(6, '2020-03-15', 'Clothing', 'Walmart', 1, 50, 51, 2);
...
(23, 'Vacation', 'save', 'Cruise', 5, 12, 10000, 4);
...
(4, 'Black', 'Widow', 'widow@avengers.com', '$2y$10$sqIw/e0kdi1TxKj.OnXLQO5FTfIDAA4Gu7gYj9ss28vXU5Cvog8..', '1');
...
ALTER TABLE `debt`
  ...
  ADD KEY `debtTrackerId` (`debtTrackerId`);
...
--
ALTER TABLE `debttrackers`
  MODIFY `debtTrackerId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `save`
--
ALTER TABLE `save`
  MODIFY `saveId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT for table `spend`
--
ALTER TABLE `spend`
  MODIFY `spendId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT for table `spendtrackers`
--
ALTER TABLE `spendtrackers`
  MODIFY `spendTrackerId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `trackers`
--
ALTER TABLE `trackers`
  MODIFY `trackerId` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
...
--
ALTER TABLE `debt`
  ADD CONSTRAINT `debtTrackerId` FOREIGN KEY (`debtTrackerId`) REFERENCES `debttrackers` (`debtTrackerId`) ON DELETE CASCADE ON UPDATE CASCADE;
